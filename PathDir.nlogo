...
to go
  ...
  print "And make sure isDirectory? finds dir1a."
  show pathdir:isDirectory? (word "dir1" sep "dir1a")
  print "And finally, ask to create the same directories again. Nothing should happen"
  print "as they already exist."
  pathdir:create (word "dir1" sep "dir1a")
  print ""
